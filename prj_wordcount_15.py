...
tot_15 = open("result_total_15.csv", "r").read().split("\n")
spr_15 = open("result_spr_15.csv", "r").read().split("\n")
smr_15 = open("result_smr_15.csv", "r").read().split("\n")
aut_15 = open("result_aut_15.csv", "r").read().split("\n")
wtr_15 = open("result_wtr_15.csv", "r").read().split("\n")
...
print(influ)
# my_list = []
# with open('result_total_15.csv', 'r') as f:
#     reader = csv.reader(f)
