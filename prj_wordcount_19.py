...
tot_19 = open("result_total_19.csv", "r").read().split("\n")
spr_19 = open("result_spr_19.csv", "r").read().split("\n")
smr_19 = open("result_smr_19.csv", "r").read().split("\n")
aut_19 = open("result_aut_19.csv", "r").read().split("\n")
wtr_19 = open("result_wtr_19.csv", "r").read().split("\n")
...
print(influ)
# my_list = []
# with open('result_total_19.csv', 'r') as f:
#     reader = csv.reader(f)
