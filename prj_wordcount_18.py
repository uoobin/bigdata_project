...
tot_18 = open("result_total_18.csv", "r").read().split("\n")
spr_18 = open("result_spr_18.csv", "r").read().split("\n")
smr_18 = open("result_smr_18.csv", "r").read().split("\n")
aut_18 = open("result_aut_18.csv", "r").read().split("\n")
wtr_18 = open("result_wtr_18.csv", "r").read().split("\n")
...
print(influ)
# my_list = []
# with open('result_total_18.csv', 'r') as f:
#     reader = csv.reader(f)
