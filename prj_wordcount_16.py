...
tot_16 = open("result_total_16.csv", "r").read().split("\n")
spr_16 = open("result_spr_16.csv", "r").read().split("\n")
smr_16 = open("result_smr_16.csv", "r").read().split("\n")
aut_16 = open("result_aut_16.csv", "r").read().split("\n")
wtr_16 = open("result_wtr_16.csv", "r").read().split("\n")
...
print(influ)
# my_list = []
# with open('result_total_16.csv', 'r') as f:
#     reader = csv.reader(f)
